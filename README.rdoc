...
Another option is to create the file ~/.flickraw.json and set the data as JSON. This file is not read if FlickrawOptions is already set when loading the library

  {
    "api_key": "... Your API key ...",
    "shared_secret": "... Your shared secret ...",
    "auth_token": "... Your saved token..."
  }
