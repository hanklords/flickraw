...
== Flickraw is now Flickr!

The FlickRaw gem is now called Flickr (=> 2.x.x). There will be no more releases of the FlickRaw gem. Please replace FlickRaw with Flickr to make sure you get the latest updates and bug fixes.
