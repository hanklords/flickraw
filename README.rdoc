...
Flickr is a library to access flickr[https://flickr.com] api in a simple way.
...
The flickraw-cached gem is on rubygems.org and should be up-to-date with regard to the Flickr API most of the time.
